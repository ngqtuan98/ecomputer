...
<head>
	...
	<!-- Favicon-->
	<link rel="shortcut icon" href="source/img/fav.png">
	<!-- Author Meta -->
		...
		<div class="main_menu">
			<nav class="navbar navbar-expand-lg navbar-light main_box">
				<div class="container">
					...
					<a class="navbar-brand logo_h" href="index.html"><img src="source/img/logo.png" alt=""></a>
						...
						<div class="row single-slide align-items-center d-flex">
							...
							<div class="col-lg-7">
								<div class="banner-img">
									<img class="img-fluid" src="source/img/banner/banner-img.png" alt="">
								</div>
							</div>
						</div>
						<!-- single-slide -->
		...
		<div class="container">
			<div class="row justify-content-center">
							...
							<div class="single-deal">
								...
								<a href="source/img/category/c1.jpg" class="img-pop-up" target="_blank">
									<div class="deal-details">
										<h6 class="deal-title">Asus vivo</h6>
									</div>
								</a>
							</div>
						</div>
						...
						<div class="col-lg-8 col-md-8">
							<div class="single-deal">
								...
								<a href="source/img/category/c4.jpg" class="img-pop-up" target="_blank">
									<div class="deal-details">
										<h6 class="deal-title">Asus Zenbook</h6>
									</div>
								</a>
							</div>
						</div>
				...
				<div class="col-lg-4 col-md-6">
					<div class="single-deal">
						<div class="overlay"></div>
						<img class="img-fluid w-100" src="source/img/category/c5.jpg" alt="">
						<a href="source/img/category/c5.jpg" class="img-pop-up" target="_blank">
							<div class="deal-details">
				...
				<div class="row">
					...
					<div class="col-lg-3 col-md-6">
						<div class="single-product">
                            <a href="{{ route('shop.show',$product->slug)}}"><img class="img-fluid" src="source/{{$product->image}}" alt=""></a>
		...
		<div class="single-product-slider">
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-lg-3 col-md-6">
						<div class="single-product">
							<img class="img-fluid" src="source/img/product/p6.jpg" alt="">
							<div class="product-details">
					...
					<div class="col-lg-3 col-md-6">
						<div class="single-product">
							<img class="img-fluid" src="source/img/product/p8.jpg" alt="">
							<div class="product-details">
								<h6>addidas New Hammer sole
									for Sports person</h6>
								<div class="price">
					...
					<div class="col-lg-3 col-md-6">
						<div class="single-product">
							<img class="img-fluid" src="source/img/product/p3.jpg" alt="">
							<div class="product-details">
								<h6>addidas New Hammer sole
									for Sports person</h6>
								<div class="price">
					...
					<div class="col-lg-3 col-md-6">
						<div class="single-product">
							<img class="img-fluid" src="source/img/product/p5.jpg" alt="">
							<div class="product-details">
								<h6>addidas New Hammer sole
									for Sports person</h6>
								<div class="price">
					...
					<div class="col-lg-3 col-md-6">
						<div class="single-product">
							<img class="img-fluid" src="source/img/product/p1.jpg" alt="">
							<div class="product-details">
								<h6>addidas New Hammer sole
									for Sports person</h6>
								<div class="price">
					...
					<div class="col-lg-3 col-md-6">
						<div class="single-product">
							<img class="img-fluid" src="source/img/product/p4.jpg" alt="">
							<div class="product-details">
								<h6>addidas New Hammer sole
									for Sports person</h6>
								<div class="price">
		...
		<div class="container">
			<div class="row">
				<a class="col single-img" href="#">
					<img class="img-fluid d-block mx-auto" src="source/img/brand/1.png" alt="">
				</a>
				<a class="col single-img" href="#">
					<img class="img-fluid d-block mx-auto" src="source/img/brand/2.png" alt="">
				</a>
				<a class="col single-img" href="#">
					<img class="img-fluid d-block mx-auto" src="source/img/brand/3.png" alt="">
				</a>
				<a class="col single-img" href="#">
					<img class="img-fluid d-block mx-auto" src="source/img/brand/4.png" alt="">
				</a>
				<a class="col single-img" href="#">
					<img class="img-fluid d-block mx-auto" src="source/img/brand/5.png" alt="">
				</a>
			</div>
		</div>
	</section>
					...
					<div class="row">
						<div class="col-lg-4 col-md-4 col-sm-6 mb-20">
							<div class="single-related-product d-flex">
								<a href="#"><img src="source/img/r1.jpg" alt=""></a>
								<div class="desc">
						...
						<div class="col-lg-4 col-md-4 col-sm-6 mb-20">
							<div class="single-related-product d-flex">
								<a href="#"><img src="source/img/r2.jpg" alt=""></a>
								<div class="desc">
									<a href="#" class="title">Black lace Heels</a>
									<div class="price">
										<h6>$189.00</h6>
						...
						<div class="col-lg-4 col-md-4 col-sm-6 mb-20">
							<div class="single-related-product d-flex">
								<a href="#"><img src="source/img/r3.jpg" alt=""></a>
								<div class="desc">
									<a href="#" class="title">Black lace Heels</a>
									<div class="price">
										<h6>$189.00</h6>
						...
						<div class="col-lg-4 col-md-4 col-sm-6 mb-20">
							<div class="single-related-product d-flex">
								<a href="#"><img src="source/img/r5.jpg" alt=""></a>
								<div class="desc">
									<a href="#" class="title">Black lace Heels</a>
									<div class="price">
										<h6>$189.00</h6>
						...
						<div class="col-lg-4 col-md-4 col-sm-6 mb-20">
							<div class="single-related-product d-flex">
								<a href="#"><img src="source/img/r6.jpg" alt=""></a>
								<div class="desc">
									<a href="#" class="title">Black lace Heels</a>
									<div class="price">
										<h6>$189.00</h6>
						...
						<div class="col-lg-4 col-md-4 col-sm-6 mb-20">
							<div class="single-related-product d-flex">
								<a href="#"><img src="source/img/r7.jpg" alt=""></a>
								<div class="desc">
									<a href="#" class="title">Black lace Heels</a>
									<div class="price">
										<h6>$189.00</h6>
				...
				<div class="col-lg-3  col-md-6 col-sm-6">
					<div class="single-footer-widget mail-chimp">
						...
						<ul class="instafeed d-flex flex-wrap">
							<li><img src="source/img/i1.jpg" alt=""></li>
							<li><img src="source/img/i2.jpg" alt=""></li>
							<li><img src="source/img/i3.jpg" alt=""></li>
							<li><img src="source/img/i4.jpg" alt=""></li>
							<li><img src="source/img/i5.jpg" alt=""></li>
							<li><img src="source/img/i6.jpg" alt=""></li>
							<li><img src="source/img/i7.jpg" alt=""></li>
							<li><img src="source/img/i8.jpg" alt=""></li>
						</ul>
					</div>
				</div>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
	...
	<script src="https://cdnjs.cloudflare.com/ajax/libs/popper.source/js/1.11.0/umd/popper.min.js" integrity="sha384-b/U6ypiBEHpOf/4+1nzFpr53nxSS+GLCkfwBdFNTxtclqqenISfwAzpKaMNFNmj4"
